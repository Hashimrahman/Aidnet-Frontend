        ...
        <div className="flex h-screen bg-[#121212] px-6 md:px-12 flex-wrap">
            <div className="w-full md:w-1/2 flex flex-col items-start justify-center md:p-6 gap-6">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <button className="bg-[#31B18D] text-white font-poppins text-lg tracking-widest font-extralight md:w-1/3 px-12 py-2  rounded-md hover:cursor-none">Know More</button>
                </div>
            </div>
